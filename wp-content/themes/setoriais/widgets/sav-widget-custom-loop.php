 ...
 *
 * Plugin Name: SAv: Widget Custom Loop
...
class SAv_Widget_Custom_Loop extends WP_Widget
{
	// ATRIBUTES /////////////////////////////////////////////////////////////////////////////////////
	var $path = '';
		...
		?>
			...
			<p>
				...
				<?php if( function_exists( 'switch_to_blog' ) ) switch_to_blog( $instance[ 'blog' ] ); ?>
					<?php wp_dropdown_categories( "id=" . $this->get_field_id( 'category' ) . "&name=" . $this->get_field_name( 'category' ) . "&show_option_all=" . __( 'All Categories' ) . "&selected={$instance[ 'category' ]}" ); ?>
	...
	// CONSTRUCTOR ///////////////////////////////////////////////////////////////////////////////////
	/**
	 * @name    SAv_Widget_Custom_Loop
	 * @author  Marcelo Mesquita <stallefish@gmail.com>
	 * @since   2009-07-17
	 * @updated 2011-11-22
	 * @return  void
	 */
	function SAv_Widget_Custom_Loop()
	{
		// define plugin path
		$this->path = dirname( __FILE__ ) . '/';

		// register widget
		$this->WP_Widget( 'custom_loop', 'SAV: Custom Loop', array( 'classname' => 'widget_custom_loop', 'description' => __( 'Allow the creation of a custom loop', 'widget-custom-loop' ) ), array( 'width' => 400 ) );
...
// register widget
add_action( 'widgets_init', create_function( '', 'return register_widget( "SAv_Widget_Custom_Loop" );' ) );
